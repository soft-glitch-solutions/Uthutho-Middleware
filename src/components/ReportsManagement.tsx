...
const ReportsManagement = ({ activeTab: externalActiveTab = 'reports-dashboard' }: ReportsManagementProps) => {
  ...
  // // Update internal tab when external prop changes
  // useState(() => {
            ...
            <CardContent className="p-8 text-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-muted-foreground">
                  The {internalActiveTab.replace(/-/g, ' ')} feature is currently under development.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>View and manage all system reports</CardDescription>
                </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Generate, view, and manage system reports</p>
      </div>
